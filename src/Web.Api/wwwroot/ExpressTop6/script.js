...
function loadLang(lang){
  $.getJSON("https://conferencecaptioning.com/ExpressTop6/" + lang + ".json", (text) => {
    localization = text
...
function getTranscript() {
  var url="https://script.google.com/macros/s/AKfycbzqOWlC9bT6TtLp1QJLzAkwDZJKTcCZYnoDhN4JIMXTo5lEvtPruYb-3vrILj__yO_A/exec?streamName=ExpressTop6";
