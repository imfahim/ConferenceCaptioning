...
function loadLang(lang){
  $.getJSON("https://conferencecaptioning.com/ExpressTop5/" + lang + ".json", (text) => {
    localization = text
...
function getTranscript() {
  var url="https://script.google.com/macros/s/AKfycbzqOWlC9bT6TtLp1QJLzAkwDZJKTcCZYnoDhN4JIMXTo5lEvtPruYb-3vrILj__yO_A/exec?streamName=ExpressTop5";
...
function translate(language){
  ...
  const apiUrl = `https://localhost:7050/api/v1/stream/view-counter`;
  const requestData = {
    method: 'POST',
    headers: {
